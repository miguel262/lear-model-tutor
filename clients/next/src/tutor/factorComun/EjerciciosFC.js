export const Ejercicio1 = {
    ...
    steps:[{
        ...
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es 3, pero la eexpresión todavía es factorizable"},
            {hintId:1, hint:"Otro factor común es 3x, pero todavía se puede agregar otro valor al factor común"},
            {hintId:2, hint:"El factor común de la expresión es 3xy"}
        ],
        answers:[{answer:"3xy", nextStep:null},
...
export const Ejercicio2 = {
    ...
    steps:[{
        stepId:0,
        expression: "\\frac{5x^6}{3y^2} - \\frac{10x^2}{21y}- \\frac{20x^3}{9y^4}",
        step: "Ingrese el factor común de la siguiente expresión: ",
        result:"( \\frac{5x^2}{3y} )( \\frac{x^4}{y} - \\frac{2}{7} - \\frac{4x}{3y^3} )",
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es 5/3, pero la eexpresión todavía es factorizable"},
            {hintId:1, hint:"Otro factor común es 5x^2/3, pero todavía se puede agregar otro valor al factor común"},
            {hintId:2, hint:"El factor común de la expresión es (5x^2)/(3y)"}
        ],
        answers:[{answer:"(5x^2)/(3y)", nextStep:null},
...
export const Ejercicio3 = {
    ...
    steps:[{
        ...
        result:"(x^2)(2y+3z)",
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es x, pero la eexpresión todavía es factorizable"},
...
export const Ejercicio4 = {
    ...
    steps:[{
        ...
        result:"(6)(2x+3y-4z)",    
        hints:[
            {hintId:0, hint:"El factor común de esta expresión es una constante"},
            {hintId:1, hint:"Un factor común de esta ecuación es 3, pero la expresión todavía es factorizable"},
...
export const Ejercicio5 = {
    ...
    steps:[{
        ...
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es 1/5, pero la eexpresión todavía es factorizable"},
            {hintId:1, hint:"Otro factor común es x/5, pero todavía se puede agregar otro valor al factor común"},
            {hintId:2, hint:"El factor común de la expresión es x^5/5"}
        ],
        //entrada:["x^5/5","(x^5)/5","(x^5)/(5)"],
        answers:[{answer:"x^5/5", nextStep:null},
...
export const Ejercicio6 = {
    ...
    steps:[{
        ...
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es 5, pero la eexpresión todavía es factorizable"},
            {hintId:1, hint:"Otro factor común es 5y, pero todavía se puede agregar otro valor al factor común"},
...
export const Ejercicio7 = {
    ...
    steps:[{
        ...
        hints:[
            {hintId:0, hint:"Un factor común de esta ecuación es 6, pero la eexpresión todavía es factorizable"},
            {hintId:1, hint:"Otro factor común es 6x, pero todavía se puede agregar otro valor al factor común"},
            {hintId:2, hint:"El factor común de la expresión es 6xyz"}
        ],
        answers:[{answer:"6xyz", nextStep:null},
